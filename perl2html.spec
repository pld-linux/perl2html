...
Summary(pl):	perl2html - konwerter ¼róde³ perlowych do HTML-a
Name:		perl2html
Version:	0.9.2
Release:	0.1
Epoch:		0
...
%description -l pl
perl2html pod¶wietla sk³adniê ¼róde³ w Perlu podobnie jak emacs.
Wyj¶cie jest w formacie HTML. Dzia³a tak¿e jako CGI konwertuj±c pliki
w locie.
